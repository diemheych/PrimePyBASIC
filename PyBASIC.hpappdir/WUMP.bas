...
170  REM DEF FNA(X)=INT(20*RND(0))+1
180  REM DEF FNB(X)=INT(3*RND(0))+1
190  REM DEF FNC(X)=INT(4*RND(0))+1
200  REM-LOCATE L ARRAY ITEMS
210  REM-1-YOU,2-WUMPUS,3&4-PITS,5&6-BATS
220  DIM L(6)
230  DIM M(6)
240   FOR J=1 TO 6
250   L(J)=INT(20*RND(1)+1)
260   M(J)=L(J)
270   NEXT J
...
530  GOTO 560
540  REM-WIN
550  PRINT "HEE HEE HEE - THE WUMPUS"
555 PRINT "WILL GETCHA NEXT TIME!!"
560   FOR J=1 TO 6
570   L(J)=M(J)
580   NEXT J
